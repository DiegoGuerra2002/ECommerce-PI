    ...
    <main>
        <section class="sec2 d-flex justify-content-center align-items-center">
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="./images/bannerConge1.png" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="./images/bannerConge2.png" class="d-block w-100" alt="...">
                    </div>
                </div>
        ...
        <section class="sec2 d-flex justify-content-center align-items-center">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 justify-content-center">
                @foreach ($pcoductos as $pcoducto)
                <div class="col mb-4">
                    <div class="card text-white bg-fe9b32">
                        <img src="{{ asset('images/' . $pcoducto->imagen) }}" class="card-img-top img-thumbnail" alt="{{ $pcoducto->nombre }}">
                        <div class="card-body">
                        <h5 class="card-title" style="text-shadow: 2px 2px 4px black;">{{ $pcoducto->nombre }}</h5> <!-- Agregar estilo para text-shadow -->
                        <p class="card-text" style="text-shadow: 2px 2px 4px black;">{{ $pcoducto->descripcion }}</p> <!-- Agregar estilo para text-shadow -->
                        <p class="card-text" style="text-shadow: 2px 2px 4px black;">${{ $pcoducto->precio }}</p> <!-- Agregar estilo para text-shadow -->
                            <!-- Input para la cantidad -->
                            <!--<div class="input-container justify-content-center">
                                <button class="decrement-button">-</button>
                                <input type="number" class="number-input" id="number{{ $pcoducto->id }}" value="0">
                                <button class="increment-button">+</button>
                            </div> -->
                            <!-- Botón "Añadir" -->
                            <!--<div class="d-flex justify-content-center mt-3">
                                <button type="button" class="btn btn-danger btn-lg" onclick="agregarProducto('{{ $pcoducto->id }}', '{{ $pcoducto->ingrediente }}', '{{ $pcoducto->precio }}')">Añadir</button>
                            </div> -->
                        </div>
                    </div>
                </div>
