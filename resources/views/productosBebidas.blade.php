...
<body>
    ...
    <main>
        ...
        <section class= "sec2 d-flex justify-content-center align-items-center">
            <h1 class= "Separadores"> Bebidas </h1>
        </section>
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-4">
                    <div class="card text-white bg-fe9b32">
                        <img src="{{ asset('images/' . $pbebida->imagen) }}" class="card-img-top img-thumbnail" alt="{{ $pbebida->nombre }}">
                        <div class="card-body">
                        <h5 class="card-title" style="text-shadow: 2px 2px 4px black;">{{ $pbebida->nombre }}</h5> <!-- Agregar estilo para text-shadow -->
                        <p class="card-text" style="text-shadow: 2px 2px 4px black;">{{ $pbebida->descripcion }}</p> <!-- Agregar estilo para text-shadow -->
                        <p class="card-text" style="text-shadow: 2px 2px 4px black;">${{ $pbebida->precio }}</p> <!-- Agregar estilo para text-shadow -->
                            <!-- Input para la cantidad -->
                            <!--<div class="input-container justify-content-center">
                                <button class="decrement-button">-</button>
                                <input type="number" class="number-input" id="number{{ $pbebida->id }}" value="0">
                                <button class="increment-button">+</button>
                            </div> -->
                            <!-- Botón "Añadir" -->
                            <!--<div class="d-flex justify-content-center mt-3">
                                <button type="button" class="btn btn-danger btn-lg" onclick="agregarProducto('{{ $pbebida->id }}', '{{ $pbebida->ingrediente }}', '{{ $pbebida->precio }}')">Añadir</button>
                            </div> -->
                        </div>
                    </div>
                </div>
